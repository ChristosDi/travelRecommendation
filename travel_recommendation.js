...
function displayResults(results) {
  ...
  const recContainer = document.querySelector(".recommendations-home");
  ...
  // Make sure the wrapper is visible with proper styling
  recWrapper.style.display = "block";
  
  // Reset scroll position to top when new results are shown
  recWrapper.scrollTop = 0;
}
